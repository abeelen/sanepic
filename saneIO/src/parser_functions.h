...
int read_dir(dictionary	*ini, struct param_common &dir, std::string dirtype ,int rank);
...
int read_apodize_samples(dictionary	*ini, struct param_sanePre &com, int rank);
