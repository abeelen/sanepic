...
//! Fill ini_var_strings structure with all structure string size (needed to commit structure)
/*!
 \param dir The param_common structure
 \param samples_struct The samples structure
...
//! Commit all the structure from rank 0 to other ranks
/*!
 * Call the functions commit_*
 \param dir The param_common structure
 \param samples_struct The samples structure
 \param pos_param The param_sanePos structure
 \param proc_param The param_sanePre structure
...
//! Fill param_common structure dir (commited from rank 0 to other ranks)
/*!
 \param dir The param_common structure
 \param ini_v empty ini_var_strings struct
 \param rank The processor rank given by MPI_Comm_rank, in case paraframe or parabolo is defined
 \return filled param_common structure
 */
int commit_param_common(struct param_common &dir, struct ini_var_strings ini_v, int rank);

//! Fill param_sanePos structure pos_param (commited from rank 0 to other ranks)
/*!
 \param pos_param The param_sanePos structure
 \param ini_v empty ini_var_strings struct
 \param rank The processor rank given by MPI_Comm_rank, in case paraframe or parabolo is defined
 \return filled param_sanePos structure
 */
int commit_param_sanePos(struct param_sanePos &pos_param, struct ini_var_strings ini_v, int rank);

//! Fill param_sanePre structure proc_param (commited from rank 0 to other ranks)
/*!
 \param proc_param The param_sanePre structure
 \param ini_v empty ini_var_strings struct
 \param rank The processor rank given by MPI_Comm_rank, in case paraframe or parabolo is defined
 \return filled param_sanePre structure
 */
int commit_param_sanePre(struct param_sanePre &proc_param, struct ini_var_strings ini_v, int rank);

//! Fill param_saneInv structure inv_param (commited from rank 0 to other ranks)
/*!
 \param inv_param The param_saneInv structure
 \param ini_v empty ini_var_strings struct
 \param rank The processor rank given by MPI_Comm_rank, in case paraframe or parabolo is defined
 \return filled param_saneInv structure
 */
int commit_param_saneInv(struct param_saneInv &inv_param, struct ini_var_strings ini_v, int rank);

//! Fill param_sanePic structure pic_param (commited from rank 0 to other ranks)
/*!
 \param pic_param The param_sanePic structure
 \param ini_v empty ini_var_strings struct
 \param rank The processor rank given by MPI_Comm_rank, in case paraframe or parabolo is defined
 \return filled param_sanePic structure
 */
int commit_param_sanePic(struct param_sanePic &pic_param, struct ini_var_strings ini_v, int rank);

//! Fill param_sanePS structure ps_param (commited from rank 0 to other ranks)
/*!
 \param ps_param The param_sanePS structure
 \param ini_v empty ini_var_strings struct
 \param rank The processor rank given by MPI_Comm_rank, in case paraframe or parabolo is defined
 \return filled param_sanePS structure
 */
int commit_param_sanePS(struct param_sanePS &ps_param, struct ini_var_strings ini_v, int rank);

//! Fill samples structure samples_struct (commited from rank 0 to other ranks)
/*!
 \param samples_struct The samples structure
 \param ini_v empty ini_var_strings struct
 \param rank The processor rank given by MPI_Comm_rank, in case paraframe or parabolo is defined
 \return filled samples structure
 */
