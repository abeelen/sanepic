...
void write_fits_hitory(std::string fnaivname,long NAXIS1, long NAXIS2, std::string path, struct param_process proc_param, struct param_positions pos_param, std::vector<double> fcut, struct detectors det, struct samples samples_struct, long ncomp=-1);
