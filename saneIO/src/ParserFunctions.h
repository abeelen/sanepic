...
uint16_t fillvect_double(std::string & output, double value, std::string filename, std::string dir, long ntotscan, std::vector<double> &outputVector);
...
uint16_t init_tmpdir(std::string &output, struct samples &samples_struct, std::string dir, int rank);
