...
#define subHeader_filename "subHeader.keyrec";
#define mapHeader_filename "mapHeader.keyrec";
...
int writeRawMapToFits(string  fname, double *S,
		long NAXIS1,  long NAXIS2, long long *indpix,	struct wcsprm *wcs, char * subheader, int nsubkeys, bool extend);
int writeFlagMapToFits(string fname, double *S,
		long NAXIS1,  long NAXIS2, long long *indpix,	struct wcsprm *wcs, char * subheader, int nsubkeys, bool extend);
int writeCCRMapToFits(string  fname, double *S, double *Mp,
		long NAXIS1, long NAXIS2,                     long long *indpix, long long *indpsrc, long long npixsrc, int factdupl, long ntotscan, struct wcsprm *wcs, char * subheader, int nsubkeys, bool extend);
int writeHitMapToFits(string  fname, long *hits, long *findChart, long long addnpix,
		long NAXIS1, long NAXIS2,  long long *indpix, long long *indpsrc, long long npixsrc, int factdupl, long ntotscan, struct wcsprm *wcs, char * subheader, int nsubkeys, bool extend);
