...
uint16_t parse_saneCheck_ini_file(char * ini_name, string &output, struct param_common &dir,
		...
		struct param_sanePS &structPS, struct param_saneInv &saneInv_struct, struct param_sanePic &sanePic_struct, struct param_saneCheck &check_struct, int rank, int size);
