 ...
 */
int parse_saneInv_ini_file(char * ini_name, std::string &fname,struct samples &samples_struct,struct directories &dir,std::string &boloname,  std::string &extentnoiseSp);
