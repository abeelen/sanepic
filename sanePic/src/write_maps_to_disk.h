...
int write_maps_to_disk(double *S, long NAXIS1, long NAXIS2, long npix, struct param_common dir, long long *indpix, long long *indpsrc,
		...
		struct param_sanePic sanePic_struct, struct param_saneInv saneInv_struct, std::vector<string> key,
		std::vector<int> datatype, std::vector<string> val, std::vector<string> com, std::vector<std::vector<std::string> > bolo_vect);
